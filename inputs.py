...
class InputData():
    ...
    def __init__(self, seed, traces, numb_quantifiers, grammar_quantifiers, grammar_structure, grammar_predicate, max_length):
         
        # seed : number representing the seed
        self.seed = seed 
        
        # traces : list of (possibly multi-dimensional) traces
        self.traces = traces 
        ...
        self.par_bounds = None #if learning_stl, then par_bounds
        ...
        self.kind_score =  'efficient_monitoring' #one among: 'fitness','stl_robustness',, 
        ...
        # By default, it is set to True. It should be specified as False, if not temporaloperators are present.
...
# grammar_structure = '''
# phi0 = always phi0 | eventually phi0 | phi0 until phi0 | s_next phi0 | s_prev phi0 | phi0 and phi0 | phi0 or phi0 | phi0 implies phi0 | phi0 equiv phi0 | not phi0 | predicate0
# '''
