...
seed_learning_1 = 625142#random.randint(0, 1000000) 
seed_positive_test_1 =  875380 #random.randint(0, 1000000)
seed_negative_test_1 = 177423#random.randint(0, 1000000) 
seed_learning_template_1 = 863687#random.randint(0, 1000000)

learning_traces_1 = dc.data_sum(numb_traces, seed_learning_1)
positive_test_traces_1 = dc.data_sum(numb_traces, seed_positive_test_1)
negative_test_traces_1 = dc.data_random_format_sum(numb_traces, seed_negative_test_1)
...
seed_learning_2 =  742902#random.randint(0, 1000000)
seed_positive_test_2 = 239391#random.randint(0, 1000000)
seed_negative_test_2 = 794136#random.randint(0, 1000000)
seed_learning_template_2 = 85511#random.randint(0, 1000000)

learning_traces_2 = dc.data_sum( numb_traces, seed_learning_2)
positive_test_traces_2 = dc.data_sum( numb_traces, seed_positive_test_2)
negative_test_traces_2 = dc.data_random_format_sum( numb_traces, seed_negative_test_2)
...
seed_learning_3 = 987172 #random.randint(0, 1000000) 
seed_positive_test_3 = 369279#random.randint(0, 1000000)
seed_negative_test_3 = 954140#random.randint(0, 1000000) 
seed_learning_template_3 = 271118#random.randint(0, 1000000)

learning_traces_3 = dc.data_sum( numb_traces, seed_learning_3)
positive_test_traces_3 = dc.data_sum( numb_traces, seed_positive_test_3)
negative_test_traces_3 = dc.data_random_format_sum( numb_traces, seed_negative_test_3)
...
seed_learning_template_1_run2 = 31500#random.randint(0, 1000000)
...
seed_learning_template_1_run3 = 595624#random.randint(0, 1000000)
...
start_time_learning_1 = time.time()
seed_learning_free_1 = 390224#random.randint(0, 1000000)
...
seed_learning_free_2 = 930096#random.randint(0, 1000000)
...
seed_learning_free_3 =  746493#random.randint(0, 1000000)
...
with open(f'{file_name}','a') as file: file.write('\n\Second run with the same traces as Experiment 1:\n\n')
seed_learning_free_1_run2 = 758899 #random.randint(0, 1000000)
...
# Third run with the same batch of data#    
#########################################
seed_learning_free_1_run3 =  955870#random.randint(0, 1000000)
with open(f'{file_name}','a') as file: file.write('\n\Third run with the same traces as Experiment 1:\n\n')
