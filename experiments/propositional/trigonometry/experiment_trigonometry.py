...
with open(f'{file_name}','a') as file: file.write('TEMPLATE SEARCH \n\n\nExperiment 1:\n\n')
...
seed_learning_1 =126024 #random.randint(0, 1000000)
seed_positive_test_1 = 530620  #random.randint(0, 1000000) 
seed_negative_test_1 =853487  #random.randint(0, 1000000) 
seed_learning_template_1 =725234#random.randint(0, 1000000)

learning_traces_1 = dc.data_trig(numb_traces, seed_learning_1)
positive_test_traces_1 = dc.data_trig(numb_traces, seed_positive_test_1)
negative_test_traces_1 = dc.data_random_format_trig(numb_traces, seed_negative_test_1)
...
grammar_structure = '''
phi0 == phi1 implies phi1 | phi1 equiv phi1
phi1 == phi1 and phi1 | phi1 or phi1| phi1 implies phi1 | phi1 equiv phi1 | not phi1 | predicate0
'''
...
input_data_template_1 = inputs.InputData(
    ...
    numb_quantifiers=[2, 2],  # Exactly two quantifiers
...
# Additional options:
input_data_template_1.bool_temporal_operators = False
...
input_data_template_1.bool_different_variables = True
...
for index, item in enumerate(output_data_template_1):
    ...
    negative_result = se.efficient_monitoring(negative_test_traces_1, tree.tree_to_formula(item.nodes),
                                              item.quantifiers, False, None, False, [], [])
...
seed_learning_2 = 335347 #random.randint(0, 1000000)
seed_positive_test_2 = 787617 #random.randint(0, 1000000) 
seed_negative_test_2 = 67328 #random.randint(0, 1000000) 
seed_learning_template_2 = 733937#random.randint(0, 1000000)

learning_traces_2 = dc.data_trig( numb_traces, seed_learning_2)
positive_test_traces_2 = dc.data_trig( numb_traces, seed_positive_test_2)
negative_test_traces_2 = dc.data_random_format_trig( numb_traces, seed_negative_test_2)
...
# Additional options:
input_data_template_2.bool_temporal_operators = False
...
input_data_template_2.bool_different_variables = True
...
seed_learning_3 = 783985 #random.randint(0, 1000000)
seed_positive_test_3 = 241541 #random.randint(0, 1000000) 
seed_negative_test_3 = 155110 #random.randint(0, 1000000) 
seed_learning_template_3 =984718 #random.randint(0, 1000000)

learning_traces_3 = dc.data_trig( numb_traces, seed_learning_3)
positive_test_traces_3 = dc.data_trig( numb_traces, seed_positive_test_3)
negative_test_traces_3 = dc.data_random_format_trig( numb_traces, seed_negative_test_3)
...
# Additional options:
input_data_template_3.bool_temporal_operators = False
...
input_data_template_3.bool_different_variables = True
...
seed_learning_template_1_run2 = 118270 #random.randint(0, 1000000)
...
input_data_template_1_run2.bool_temporal_operators = False
...
input_data_template_1_run2.bool_different_variables = True
...
seed_learning_template_1_run3 = 65728 #random.randint(0, 1000000)
...
# Additional options:
input_data_template_1_run3.bool_temporal_operators = False
...
input_data_template_1_run3.bool_different_variables = True
...
start_time_learning_1 = time.time()
seed_learning_free_1 = 507453 #random.randint(0, 1000000)
...
# Definition of the grammar for the formula structure
grammar_structure = '''
phi0 == phi0 and phi0 | phi0 or phi0 | phi0 implies phi0 | phi0 equiv phi0 | not phi0 | predicate0
'''
...
# Additional options:
input_data_free_1.bool_temporal_operators = False
input_data_free_1.bool_different_variables = True
...
seed_learning_free_2 = 40014 #random.randint(0, 1000000)
...
# Additional options:
input_data_free_2.bool_temporal_operators = False
input_data_free_2.bool_different_variables = True
...
seed_learning_free_3 = 354350#random.randint(0, 1000000)
...
# Additional options:
input_data_free_3.bool_temporal_operators = False
input_data_free_3.bool_different_variables = True
...
with open(f'{file_name}','a') as file: file.write('\n\Second run with the same traces as Experiment 1:\n\n')
seed_learning_free_1_run2 = 339397 #random.randint(0, 1000000)
...
# Additional options:
input_data_free_1_run2.bool_temporal_operators = False
input_data_free_1_run2.bool_different_variables = True
...
# Third run with the same batch of data#    
#########################################
seed_learning_free_1_run3 = 204368 #random.randint(0, 1000000)
with open(f'{file_name}','a') as file: file.write('\n\Third run with the same traces as Experiment 1:\n\n')
...
# Additional options:
input_data_free_1_run3.bool_temporal_operators = False
input_data_free_1_run3.bool_different_variables = True
