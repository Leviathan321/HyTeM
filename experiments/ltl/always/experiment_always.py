...
seed_learning_1 = 904258#random.randint(0, 1000000)
seed_positive_test_1 = 492878#random.randint(0, 1000000)
seed_negative_test_1 = 797907#random.randint(0, 1000000)
seed_learning_template_1 = 24649#random.randint(0, 1000000)

learning_traces_1 = dc.data_always(length_time, numb_traces, seed_learning_1)
positive_test_traces_1 = dc.data_always(length_time, numb_traces, seed_positive_test_1)
...
seed_learning_2 = 362440#random.randint(0, 1000000)
seed_positive_test_2 = 575968#random.randint(0, 1000000)
seed_negative_test_2 = 656835#random.randint(0, 1000000)
seed_learning_template_2 =27226 #random.randint(0, 1000000)

learning_traces_2 = dc.data_always(length_time, numb_traces, seed_learning_2)
positive_test_traces_2 = dc.data_always(length_time, numb_traces, seed_positive_test_2)
...
seed_learning_3 = 546780#random.randint(0, 1000000)
seed_positive_test_3 = 752343#random.randint(0, 1000000)
seed_negative_test_3 = 777116#random.randint(0, 1000000)
seed_learning_template_3 = 11281#random.randint(0, 1000000)

learning_traces_3 = dc.data_always(length_time, numb_traces, seed_learning_3)
positive_test_traces_3 = dc.data_always(length_time, numb_traces, seed_positive_test_3)
...
seed_learning_template_1_run2 = 367158#random.randint(0, 1000000)
...
seed_learning_template_1_run3 =17717 #random.randint(0, 1000000)
...
start_time_learning_1 = time.time()
seed_learning_free_1 =625444  #random.randint(0, 1000000)
...
seed_learning_free_2 = 874342#random.randint(0, 1000000)
...
seed_learning_free_3 = 294100#random.randint(0, 1000000)
...
with open(f'{file_name}','a') as file: file.write('\n\Second run with the same traces as Experiment 1:\n\n')
seed_learning_free_1_run2 = 297922#random.randint(0, 1000000)
...
# Third run with the same batch of data#    
#########################################
seed_learning_free_1_run3 = 743858#random.randint(0, 1000000)
with open(f'{file_name}','a') as file: file.write('\n\Third run with the same traces as Experiment 1:\n\n')
