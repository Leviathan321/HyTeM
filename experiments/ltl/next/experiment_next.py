...
seed_learning_1 = 789526#random.randint(0, 1000000)
seed_positive_test_1 =723909#random.randint(0, 1000000)
seed_negative_test_1 = 574728#random.randint(0, 1000000)
seed_learning_template_1 =338927 #random.randint(0, 1000000)

learning_traces_1 = dc.data_next(length_time, numb_traces, seed_learning_1)
positive_test_traces_1 = dc.data_next(length_time, numb_traces, seed_positive_test_1)
...
seed_learning_2 = 13426#random.randint(0, 1000000)
seed_positive_test_2 =795330 #random.randint(0, 1000000)
seed_negative_test_2 =931448 #random.randint(0, 1000000)
seed_learning_template_2 = 687104#random.randint(0, 1000000)

learning_traces_2 = dc.data_next(length_time, numb_traces, seed_learning_2)
positive_test_traces_2 = dc.data_next(length_time, numb_traces, seed_positive_test_2)
...
seed_learning_3 = 378325#random.randint(0, 1000000)
seed_positive_test_3 = 822428#random.randint(0, 1000000)
seed_negative_test_3 = 229828#random.randint(0, 1000000)
seed_learning_template_3 = 137038#random.randint(0, 1000000)

learning_traces_3 = dc.data_next(length_time, numb_traces, seed_learning_3)
positive_test_traces_3 = dc.data_next(length_time, numb_traces, seed_positive_test_3)
...
seed_learning_template_1_run2 = 195572#random.randint(0, 1000000)
...
seed_learning_template_1_run3 = 431134#random.randint(0, 1000000)
...
start_time_learning_1 = time.time()
seed_learning_free_1 =  634888#random.randint(0, 1000000)
...
seed_learning_free_2 = 286778#random.randint(0, 1000000)
...
seed_learning_free_3 =212885 #random.randint(0, 1000000)
...
with open(f'{file_name}','a') as file: file.write('\n\Second run with the same traces as Experiment 1:\n\n')
seed_learning_free_1_run2 =186205 #random.randint(0, 1000000)
...
# Third run with the same batch of data#    
#########################################
seed_learning_free_1_run3 = 289835#random.randint(0, 1000000)
with open(f'{file_name}','a') as file: file.write('\n\Third run with the same traces as Experiment 1:\n\n')
