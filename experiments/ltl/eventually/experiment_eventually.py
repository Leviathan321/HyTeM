...
# random.seed(1)
seed_learning_1 = 542891#random.randint(0, 1000000)
seed_positive_test_1 = 513195#random.randint(0, 1000000)
seed_negative_test_1 = 173598#random.randint(0, 1000000)
seed_learning_template_1 = 91073#random.randint(0, 1000000)

learning_traces_1 = dc.data_eventually(length_time, numb_traces, seed_learning_1)
positive_test_traces_1 = dc.data_eventually(length_time, numb_traces, seed_positive_test_1)
...
seed_learning_2 = 234704#random.randint(0, 1000000)
seed_positive_test_2 = 816192#random.randint(0, 1000000)
seed_negative_test_2 =218829 #random.randint(0, 1000000)
seed_learning_template_2 =458790 #random.randint(0, 1000000)

learning_traces_2 = dc.data_eventually(length_time, numb_traces, seed_learning_2)
positive_test_traces_2 = dc.data_eventually(length_time, numb_traces, seed_positive_test_2)
...
seed_learning_3 = 987529#random.randint(0, 1000000)
seed_positive_test_3 = 503165#random.randint(0, 1000000)
seed_negative_test_3 = 356914#random.randint(0, 1000000)
seed_learning_template_3 = 533391#random.randint(0, 1000000)

learning_traces_3 = dc.data_eventually(length_time, numb_traces, seed_learning_3)
positive_test_traces_3 = dc.data_eventually(length_time, numb_traces, seed_positive_test_3)
...
seed_learning_template_1_run2 = 438038#random.randint(0, 1000000)
...
seed_learning_template_1_run3 = 377903#random.randint(0, 1000000)
...
start_time_learning_1 = time.time()
seed_learning_free_1 = 916128#random.randint(0, 1000000)
...
seed_learning_free_2 = 845401#random.randint(0, 1000000)
...
seed_learning_free_3 = 541291#random.randint(0, 1000000)
...
with open(f'{file_name}','a') as file: file.write('\n\Second run with the same traces as Experiment 1:\n\n')
seed_learning_free_1_run2 = 859264#random.randint(0, 1000000)
...
# Third run with the same batch of data#    
#########################################
seed_learning_free_1_run3 = 551069#random.randint(0, 1000000)
with open(f'{file_name}','a') as file: file.write('\n\Third run with the same traces as Experiment 1:\n\n')
