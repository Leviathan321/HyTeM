...
file_name = 'Philosophers_second_template.text'

with open(f'{file_name}','a') as file:
    file.write('TEMPLATE SEARCH \n\n\nExperiment 1:\n\n')

numb_formulas = 100 # number of formulas to be learned
...
input_data_template_1.name_set_mined_formulas = 'second_template_'
