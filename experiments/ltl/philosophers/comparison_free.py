...
file_name = 'Philosophers_free_comparison.text'
...
seed_learning_template_1 = 365757#random.randint(0, 1000000)
...
grammar_structure = '''
phi0 == always phi1
phi1 ==  phi1 until phi1 | s_next phi1 | phi1 and phi1 | phi1 or phi1 | phi1 implies phi1 | not phi1 | predicate0
'''
...
input_data_template_1.name_set_mined_formulas = 'first_template_'
