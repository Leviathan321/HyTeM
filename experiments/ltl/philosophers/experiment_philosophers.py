...
seed_negative_test_1 = 829047#random.randint(0, 1000000)
seed_learning_template_1 = 365756#random.randint(0, 1000000)


learning_traces_1, positive_test_traces_1, _  = dc.data_philosophers()
 
negative_test_traces_1 = dc.data_philosophers_random(363, 1, seed_negative_test_1)
...
# seed_learning_2 = random.randint(0, 1000000)

seed_negative_test_2 = 10572#random.randint(0, 1000000)
seed_learning_template_2 = 560658#random.randint(0, 1000000)

_, learning_traces_2, positive_test_traces_2,  = dc.data_philosophers()
negative_test_traces_2 = dc.data_philosophers_random(363, 1,  seed_negative_test_2)
...
input_data_template_2.second_variable = [0,1,2] # 3 actions
input_data_template_2.to_be_present = [[f'pi[0][{agent}] == {action}' for agent in range(n) for action in input_data_template_2.second_variable ], 2 ]
...
# seed_learning_3 = random.randint(0, 1000000)
seed_negative_test_3 = 50377#random.randint(0, 1000000)
seed_learning_template_3 = 690242#random.randint(0, 1000000)

positive_test_traces_3, _, learning_traces_3  = dc.data_philosophers()
negative_test_traces_3 = dc.data_philosophers_random(363, 1,  seed_negative_test_3)
...
input_data_template_3.second_variable = [0,1,2] # 3 actions
input_data_template_3.to_be_present = [[f'pi[0][{agent}] == {action}' for agent in range(n) for action in input_data_template_3.second_variable ], 2 ]
...
seed_learning_template_1_run2 =350548 #random.randint(0, 1000000)
...
input_data_template_1_run2.second_variable = [0,1,2] # 3 actions
input_data_template_1_run2.to_be_present = [[f'pi[0][{agent}] == {action}' for agent in range(n) for action in input_data_template_1_run2.second_variable ], 2 ]
...
seed_learning_template_1_run3 = 100182#random.randint(0, 1000000)
...
input_data_template_1_run3.second_variable = [0,1,2] # 3 actions
input_data_template_1_run3.to_be_present = [[f'pi[0][{agent}] == {action}' for agent in range(n) for action in input_data_template_1_run3.second_variable ], 2 ]
...
start_time_learning_1 = time.time()
seed_learning_free_1 = 905413#random.randint(0, 1000000)
...
# Additional options:
input_data_free_1.second_variable = [0,1,2] # 3 actions
input_data_free_1.to_be_present = [[f'pi[0][{agent}] == {action}' for agent in range(n) for action in input_data_free_1.second_variable ], 2 ]
...
seed_learning_free_2 = 529178#random.randint(0, 1000000)
...
# Additional options:
input_data_free_2.second_variable = [0,1,2] # 3 actions
input_data_free_2.to_be_present = [[f'pi[0][{agent}] == {action}' for agent in range(n) for action in input_data_free_2.second_variable ], 2 ]
...
seed_learning_free_3 = 752766#random.randint(0, 1000000)
...
# Additional options:
input_data_free_3.second_variable = [0,1,2] # 3 actions
input_data_free_3.to_be_present = [[f'pi[0][{agent}] == {action}' for agent in range(n) for action in input_data_free_3.second_variable ], 2 ]
...
with open(f'{file_name}','a') as file: file.write('\n\Second run with the same traces as Experiment 1:\n\n')
seed_learning_free_1_run2 = 994806#random.randint(0, 1000000)
...
# Additional options:
input_data_free_1_run2.second_variable = [0,1,2] # 3 actions
input_data_free_1_run2.to_be_present = [[f'pi[0][{agent}] == {action}' for agent in range(n) for action in input_data_free_1_run2.second_variable ], 2 ]
...
# Third run with the same batch of data#    
#########################################
seed_learning_free_1_run3 = 623577#random.randint(0, 1000000)
with open(f'{file_name}','a') as file: file.write('\nThird run with the same traces as Experiment 1:\n\n')
...
# Additional options:
input_data_free_1_run3.second_variable = [0,1,2] # 3 actions
input_data_free_1_run3.to_be_present = [[f'pi[0][{agent}] == {action}' for agent in range(n) for action in input_data_free_1_run3.second_variable ], 2 ]
