...
seed_learning_1 = 955793#random.randint(0, 1000000)
seed_positive_test_1 = 258737#random.randint(0, 1000000)
seed_negative_test_1 = 237017#random.randint(0, 1000000)
seed_learning_template_1 = 714350#random.randint(0, 1000000)

learning_traces_1 = dc.data_until(length_time, numb_traces, seed_learning_1)
positive_test_traces_1 = dc.data_until(length_time, numb_traces, seed_positive_test_1)
...
seed_learning_2 = 713760#random.randint(0, 1000000)
seed_positive_test_2 = 983614#random.randint(0, 1000000)
seed_negative_test_2 = 880644#random.randint(0, 1000000)
seed_learning_template_2 = 887746#random.randint(0, 1000000)

learning_traces_2 = dc.data_until(length_time, numb_traces, seed_learning_2)
positive_test_traces_2 = dc.data_until(length_time, numb_traces, seed_positive_test_2)
...
seed_learning_3 =919746 #random.randint(0, 1000000)
seed_positive_test_3 = 919951#random.randint(0, 1000000)
seed_negative_test_3 = 139166#random.randint(0, 1000000)
seed_learning_template_3 = 344085#random.randint(0, 1000000)

learning_traces_3 = dc.data_until(length_time, numb_traces, seed_learning_3)
positive_test_traces_3 = dc.data_until(length_time, numb_traces, seed_positive_test_3)
...
seed_learning_template_1_run2 = 965183#random.randint(0, 1000000)
...
seed_learning_template_1_run3 = 904460#random.randint(0, 1000000)
...
start_time_learning_1 = time.time()
seed_learning_free_1 = 838734#random.randint(0, 1000000)
...
seed_learning_free_2 =156281 #random.randint(0, 1000000)
...
seed_learning_free_3 =785445 #random.randint(0, 1000000)
...
with open(f'{file_name}','a') as file: file.write('\n\Second run with the same traces as Experiment 1:\n\n')
seed_learning_free_1_run2 =659810 #random.randint(0, 1000000)
...
# Third run with the same batch of data#    
#########################################
seed_learning_free_1_run3 = 726523#random.randint(0, 1000000)
with open(f'{file_name}','a') as file: file.write('\n\Third run with the same traces as Experiment 1:\n\n')
