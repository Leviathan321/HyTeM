...
# # random.seed(1)
seed_learning_1 = 786574#random.randint(0, 1000000)
seed_positive_test_1 =664572# random.randint(0, 1000000) 
seed_negative_test_1 = 528136 #random.randint(0, 1000000) 
seed_learning_template_1 =246 #random.randint(0, 1000000)

learning_traces_1 = dc.data_serial_adder(length_time, numb_traces, seed_learning_1)
positive_test_traces_1 = dc.data_serial_adder(length_time, numb_traces, seed_positive_test_1)
negative_test_traces_1 = dc.data_random_three(length_time, numb_traces, seed_negative_test_1)
...
phi3 == always phi4
phi4 == phi4 and phi4 | phi4 or phi4 | phi4 implies phi4 | phi4 equiv phi4 | not phi4 | predicate1
'''

# Definition of the grammar for  predicates
#Definition of the grammar for  predicates
grammar_predicate = [ ]
predicate0 = [['=='], list(range(0,n-1)), 'all tuples' ] #[ item for item in itertools.permutations(range(number_quantifiers), min(number_quantifiers,2))]
grammar_predicate.append([predicate0])
predicate1 = [['=='], list(range(n-1,n)), 'all tuples' ] #[ item for item in itertools.permutations(range(number_quantifiers), min(number_quantifiers,2))]
...
# Additional options:
input_data_template_1.bool_interface_aware = True
input_data_template_1.input_variables  = list(range(0,n-1))
input_data_template_1.output_variables = list(range(n-1,n))
...
for index, item in enumerate(output_data_template_1):
    positive_result = se.efficient_monitoring(positive_test_traces_1, tree.tree_to_formula(item.nodes), item.quantifiers, True, None, 
                            input_data_template_1.bool_interface_aware , input_data_template_1.input_variables, input_data_template_1.output_variables )
    negative_result = se.efficient_monitoring(negative_test_traces_1, tree.tree_to_formula(item.nodes),
                                              item.quantifiers, True, None, 
                                              input_data_template_1.bool_interface_aware , input_data_template_1.input_variables, input_data_template_1.output_variables)
...
seed_learning_2 = 68304#random.randint(0, 1000000)
seed_positive_test_2 = 927137#random.randint(0, 1000000) 
seed_negative_test_2 = 763247#random.randint(0, 1000000)
seed_learning_template_2 = 835020#random.randint(0, 1000000)

learning_traces_2 = dc.data_serial_adder(length_time, numb_traces, seed_learning_2)
positive_test_traces_2 = dc.data_serial_adder(length_time, numb_traces, seed_positive_test_2)
negative_test_traces_2 = dc.data_random_three(length_time, numb_traces, seed_negative_test_2)
...
# Additional options:
input_data_template_2.bool_interface_aware = True
input_data_template_2.input_variables  = list(range(0,n-1))
input_data_template_2.output_variables = list(range(n-1,n))
...
for index, item in enumerate(output_data_template_2):
    positive_result = se.efficient_monitoring(positive_test_traces_2, tree.tree_to_formula(item.nodes), item.quantifiers,
                            True, None, 
                            input_data_template_2.bool_interface_aware, input_data_template_2.input_variables, input_data_template_2.output_variables)
...
seed_learning_3 = 238#random.randint(0, 1000000) 
seed_positive_test_3 = 756773#random.randint(0, 1000000) 
seed_negative_test_3 = 160234#random.randint(0, 1000000) 
seed_learning_template_3 = 853384#random.randint(0, 1000000)

learning_traces_3 = dc.data_serial_adder(length_time, numb_traces, seed_learning_3)
positive_test_traces_3 = dc.data_serial_adder(length_time, numb_traces, seed_positive_test_3)
negative_test_traces_3 = dc.data_random_three(length_time, numb_traces, seed_negative_test_3)
...
# Additional options:
input_data_template_3.bool_interface_aware = True
input_data_template_3.input_variables  = list(range(0,n-1))
input_data_template_3.output_variables = list(range(n-1,n))
...
for index, item in enumerate(output_data_template_3):
    positive_result = se.efficient_monitoring(positive_test_traces_3, tree.tree_to_formula(item.nodes), item.quantifiers,
                            True, None, 
                            input_data_template_3.bool_interface_aware, input_data_template_3.input_variables, input_data_template_3.output_variables)
...
seed_learning_template_1_run2 = 894361 #random.randint(0, 1000000)
...
# Additional options:
input_data_template_1_run2.bool_interface_aware = True
input_data_template_1_run2.input_variables  = list(range(0,n-1))
input_data_template_1_run2.output_variables = list(range(n-1,n))
...
seed_learning_template_1_run3 = 705782 #random.randint(0, 1000000)
...
# Additional options:
input_data_template_1_run3.bool_interface_aware = True
input_data_template_1_run3.input_variables  = list(range(0,n-1))
input_data_template_1_run3.output_variables = list(range(n-1,n))
...
start_time_learning_1 = time.time()
seed_learning_free_1 = 427329#random.randint(0, 1000000)
...
seed_learning_free_2 = 807932# random.randint(0, 1000000)
...
seed_learning_free_3 = 99109 #random.randint(0, 1000000)
...
with open(f'{file_name}','a') as file: file.write('\n\Second run with the same traces as Experiment 1:\n\n')
seed_learning_free_1_run2 = 388513#random.randint(0, 1000000)
...
# Third run with the same batch of data#    
#########################################
seed_learning_free_1_run3 = 224204 #random.randint(0, 1000000)
with open(f'{file_name}','a') as file: file.write('\n\Third run with the same traces as Experiment 1:\n\n')
