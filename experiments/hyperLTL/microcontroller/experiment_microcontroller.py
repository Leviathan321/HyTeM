...
seed_negative_test_1 = 172577 #random.randint(0, 1000000)
...
negative_test_traces_1 = dc.data_random_microcontroller(min_length, numb_traces, seed_negative_test_1)
...
seed_learning_2 = 249114#random.randint(0, 1000000)
seed_negative_test_2 = 665388#random.randint(0, 1000000)
seed_learning_template_2 = 259318#random.randint(0, 1000000)

learning_traces_2, positive_test_traces_2 , min_length = dc.data_microcontroller( numb_traces, seed_learning_2)
negative_test_traces_2 = dc.data_random_microcontroller(min_length, numb_traces, seed_negative_test_2)
...
seed_learning_3 = 701717#random.randint(0, 1000000)
seed_negative_test_3 = 788780#random.randint(0, 1000000)
seed_learning_template_3 = 588467#random.randint(0, 1000000)

learning_traces_3, positive_test_traces_3 , min_length = dc.data_microcontroller( numb_traces, seed_learning_3)

negative_test_traces_3 = dc.data_random_microcontroller(min_length, numb_traces, seed_negative_test_3)
...
seed_learning_template_1_run2 = 137369#random.randint(0, 1000000)
...
seed_learning_template_1_run3 = 755069#random.randint(0, 1000000)
...
start_time_learning_1 = time.time()
seed_learning_free_1 = random.randint(0, 1000000)
...
seed_learning_free_2 = random.randint(0, 1000000)
...
seed_learning_free_3 = random.randint(0, 1000000)
...
with open(f'{file_name}','a') as file: file.write('\n\Second run with the same traces as Experiment 1:\n\n')
seed_learning_free_1_run2 = random.randint(0, 1000000)
...
# Third run with the same batch of data#    
#########################################
seed_learning_free_1_run3 = random.randint(0, 1000000)
with open(f'{file_name}','a') as file: file.write('\n\Third run with the same traces as Experiment 1:\n\n')
